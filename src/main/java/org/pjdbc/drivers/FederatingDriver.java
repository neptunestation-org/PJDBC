...
public class FederatingDriver extends AbstractDriver {
    ...
    /** Shared patterns for SQL separators (whitespace and comments) */
    ...
    public Connection connect(String url, Properties info) throws SQLException {
        ...
        String[] urls = splitUrls(subname);
        List<String> targetUrlList = Arrays.asList(urls);

        FederateConfig config = FederateConfig.fromUrl(url, targetUrlList);
    ...
    private static class FederatingConnection extends AbstractConnection {
        ...
        public PreparedStatement prepareStatement(String sql) throws SQLException {
            ...
            return new FederatingPreparedStatement(stmts.toArray(new PreparedStatement[0]), this, config, sql);
        }
    ...
    private static class FederatingPreparedStatement extends AbstractPreparedStatement {
        ...
        public FederatingPreparedStatement(PreparedStatement[] delegates, Connection conn, FederateConfig config, String sql) throws SQLException {
