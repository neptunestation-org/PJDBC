...
public class SchemaTransformer extends AbstractJdbcTransformer {
    ...
    // Captures: keyword, optional separator, table name (not already qualified)
    ...
    public String transformSql(String sql) throws SQLException {
        ...
        while (matcher.find()) {
            ...
            matcher.appendReplacement(result, keyword + Matcher.quoteReplacement(sep) + schemaPrefix + tableName);
        }
