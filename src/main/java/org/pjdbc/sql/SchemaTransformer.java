...
public class SchemaTransformer extends AbstractJdbcTransformer {
    ...
    public String transformSql(String sql) throws SQLException {
        ...
        while (matcher.find()) {
            ...
            // Use Matcher.quoteReplacement for separator as it might contain special characters in comments
            matcher.appendReplacement(result, keyword + Matcher.quoteReplacement(separator) + schemaPrefix + tableName);
        }
