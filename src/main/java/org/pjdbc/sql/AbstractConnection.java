...
public abstract class AbstractConnection extends AbstractWrapper implements Connection {
    ...
    @Override
    public PreparedStatement prepareStatement (String sql) throws SQLException {ArrayList<PreparedStatement> stmts = new ArrayList<PreparedStatement>(); for (Connection d : getConnections()) stmts.add(d.prepareStatement(sql)); return wrap(stmts.toArray(new PreparedStatement[0]));}
    @Override
    public PreparedStatement prepareStatement (String sql, String[] columnNames) throws SQLException {ArrayList<PreparedStatement> stmts = new ArrayList<PreparedStatement>(); for (Connection d : getConnections()) stmts.add(d.prepareStatement(sql, columnNames)); return wrap(stmts.toArray(new PreparedStatement[0]));}
    @Override
    public PreparedStatement prepareStatement (String sql, int autoGeneratedKeys) throws SQLException {ArrayList<PreparedStatement> stmts = new ArrayList<PreparedStatement>(); for (Connection d : getConnections()) stmts.add(d.prepareStatement(sql, autoGeneratedKeys)); return wrap(stmts.toArray(new PreparedStatement[0]));}
    @Override
    public PreparedStatement prepareStatement (String sql, int resultSetType, int resultSetConcurrency) throws SQLException {ArrayList<PreparedStatement> stmts = new ArrayList<PreparedStatement>(); for (Connection d : getConnections()) stmts.add(d.prepareStatement(sql, resultSetType, resultSetConcurrency)); return wrap(stmts.toArray(new PreparedStatement[0]));}
    @Override
    public PreparedStatement prepareStatement (String sql, int resultSetType, int resultSetConcurrency, int resultSetHoldability) throws SQLException {ArrayList<PreparedStatement> stmts = new ArrayList<PreparedStatement>(); for (Connection d : getConnections()) stmts.add(d.prepareStatement(sql, resultSetType, resultSetConcurrency, resultSetHoldability)); return wrap(stmts.toArray(new PreparedStatement[0]));}
    @Override
    public PreparedStatement prepareStatement (String sql, int[] columnIndexes) throws SQLException {ArrayList<PreparedStatement> stmts = new ArrayList<PreparedStatement>(); for (Connection d : getConnections()) stmts.add(d.prepareStatement(sql, columnIndexes)); return wrap(stmts.toArray(new PreparedStatement[0]));}
    @Override
